...
# Prebuilt Core
BOARD_PREBUILT_DTBOIMAGE := $(DEVICE_PATH)/prebuilt/dtbo12.2.3.img
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/boot12.2.3.img-zImage
TARGET_PREBUILT_DTB := $(DEVICE_PATH)/prebuilt/boot12.2.3.img-dtb
